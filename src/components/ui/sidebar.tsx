  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=inset]:rounded-lg group-data-[variant=inset]:border-2 group-data-[variant=inset]:border-border group-data-[variant=inset]:shadow-shadow"
        >
          {children}
        </div>
      </div>
