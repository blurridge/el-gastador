    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Make sure to choose the right category to ensure it gets marked the right transaction type.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
                  ...
                  <Select value={field.value} onValueChange={(value) => field.onChange(value)}>
                    <FormControl>
                      <SelectTrigger className="bg-white">
                        <SelectValue placeholder="Transaction Category">{field.value ? findCategoryNameById(field.value) : ''}</SelectValue>
                      </SelectTrigger>
                    </FormControl>
